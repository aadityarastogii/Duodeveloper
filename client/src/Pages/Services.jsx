...
export default function Services() {
  ...
  const servicesSchema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://duodeveloper.com/services/#webpage",
        "url": "https://duodeveloper.com/services/",
        "name": "Web & App Development Services | DuoDeveloper",
        "description": "Explore DuoDeveloper's web development, mobile app development, UI/UX design, and digital product services built for modern businesses.",
        "isPartOf": {
          "@id": "https://duodeveloper.com/#website"
        }
      },
      {
        "@type": ["LocalBusiness", "ProfessionalService", "WebDesign"],
        "@id": "https://duodeveloper.com/#localbusiness",
        "name": "DuoDeveloper",
        "url": "https://duodeveloper.com",
        "logo": "https://duodeveloper.com/logo.png",
        "telephone": "+1-800-000-0000",
        "email": "hello@duodeveloper.com",
        "address": {
          "@type": "PostalAddress",
      ...
      {
        "@type": "Service",
        "@id": "https://duodeveloper.com/services/#service",
        "name": "Web & App Development Services",
        "description": "End-to-end website development, mobile app development, UI/UX design, and product growth solutions for modern businesses.",
        "provider": {
          "@id": "https://duodeveloper.com/#localbusiness"
        },
        "areaServed": {
          ...
          "itemListElement": [
            {
              ...
              "itemOffered": {
                ...
                "url": "https://duodeveloper.com/services/web-development/"
              }
            },
            {
              "@type": "Offer",
              "itemOffered": {
                ...
                "url": "https://duodeveloper.com/services/social-media-marketing/"
              }
            },
            {
              "@type": "Offer",
              "itemOffered": {
                ...
                "url": "https://duodeveloper.com/services/digital-marketing/"
              }
            },
            {
              "@type": "Offer",
              "itemOffered": {
                "@type": "Service",
                "name": "UI/UX Design",
                "url": "https://duodeveloper.com/services/brand-identity/"
              }
            }
          ]
        }
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://duodeveloper.com/services/#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
            "name": "Home",
            "item": "https://duodeveloper.com/"
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": "Services",
            "item": "https://duodeveloper.com/services/"
          }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://duodeveloper.com/services/#faqpage",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What web and app development services does DuoDeveloper offer?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We build custom websites, mobile apps, web applications, and UI/UX experiences that help businesses launch faster and scale with confidence."
            }
          },
          {
            "@type": "Question",
            "name": "Do you build both websites and mobile apps?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. DuoDeveloper creates high-quality websites, mobile apps, and digital products designed to align with your business goals and user needs."
            }
          },
          {
            "@type": "Question",
            "name": "Why hire a development agency instead of freelancers?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "A dedicated agency gives you a complete product team, a clear process, and better coordination from strategy and design through development and launch."
            }
          }
        ]
      }
  ...
  return (
    <div className="min-h-screen relative bg-[#050505] text-white font-sans overflow-x-hidden">
      <SEO
        title="Our Services | DuoDeveloper"
        description="DuoDeveloper builds custom websites, mobile apps, and digital products for businesses that want faster growth and better user experiences."
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Web & App Development Services<br />
              <span className="bg-gradient-to-r from-[#04AAA5] via-white to-[#FBB040] bg-clip-text text-transparent italic">
                Built for Growth
              </span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed font-light">
              From strategy and design to development and launch, DuoDeveloper creates digital products that help businesses grow faster and operate smarter.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h3 className="text-white font-bold text-3xl mb-4 tracking-tight">Ready to Build?</h3>
                <p className="text-gray-300 text-sm leading-relaxed mb-10 max-w-[250px]">
                  Tell us about your idea and we’ll help shape the right digital solution for your business.
                </p>
