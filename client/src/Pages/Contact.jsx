...
export default function Contact() {
  ...
  const CONTACT_INFO = [
    ...
    { icon: "✉️", label: "Email", val: "duodevelopers2026@gmail.com", link: "mailto:duodevelopers2026@gmail.com" },
  ];
  ...
  const contactSchema = {
    ...
    "@graph": [
      {
        "@type": "ContactPage",
        "@id": "https://duodeveloper.com/contact/#webpage",
        "url": "https://duodeveloper.com/contact/",
        "name": "Contact Us | DuoDeveloper",
        "description": "Contact DuoDeveloper for website, app, and digital product development services.",
        "isPartOf": {
      ...
      },
      {
        ...
        "@id": "https://duodeveloper.com/#organization",
        "name": "DuoDeveloper",
        "url": "https://duodeveloper.com",
        "email": "duodevelopers2026@gmail.com",
        "telephone": "+91 80815 54740",
        "contactPoint": {
          "@type": "ContactPoint",
          "telephone": "+91 80815 54740",
          "email": "duodevelopers2026@gmail.com",
  ...
  return (
    <div className="min-h-screen relative bg-[#050505] text-white font-sans overflow-x-hidden selection:bg-[#04AAA5]/30">
      <SEO
        title="Contact Us | DuoDeveloper"
        description="Ready to build your next website or app? Contact DuoDeveloper today to discuss your project and get a custom solution."
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed font-light mb-10 max-w-lg border-l-2 border-[#04AAA5] pl-6">
                Ready to build a website or app that actually moves your business forward? Let’s talk about your goals and create the right digital solution for you.
              </p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 text-gray-300 text-[15px] focus:outline-none focus:border-[#04AAA5] focus:bg-[#04AAA5]/5 focus:ring-1 focus:ring-[#04AAA5] transition-all appearance-none cursor-pointer">
                        ...
                        <option className="bg-[#060a0d]">Web App Development</option>
