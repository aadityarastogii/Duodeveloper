...
export default function BlogCard({ post, index }) {
  return (
    <motion.a
      ...
      whileHover={{ y: -8 }}
      className="group flex flex-col rounded-3xl border border-white/5 bg-white/[0.02] backdrop-blur-md overflow-hidden hover:bg-white/[0.04] hover:border-[#FBB040]/30 transition-all duration-500 h-full"
    >
