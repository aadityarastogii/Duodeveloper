...
export default function FeaturedPost({ post }) {
  return (
    <motion.a
      ...
      viewport={{ once: true }}
      whileHover={{ y: -5 }}
      className="group relative block w-full rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-md overflow-hidden hover:border-[#04AAA5]/40 transition-all duration-500 mb-16"
    >
